export const projects = [
    ...
    },
    {
        ...
        gallery: [
            ...
            '/assets/unaoc-images/unaoc3.png',
            '/assets/unaoc-images/unaoc_alt_app.png',
            '/assets/unaoc-images/unaocapp.webp',
            '/assets/unaoc-images/unaocapp1.png',
            '/assets/unaoc-images/unaocapp3.png',
            '/assets/unaoc-images/unaocappmedia.png',
            '/assets/unaoc-images/unaocdes10.png',
            '/assets/unaoc-images/unaocdes4.png',
            '/assets/unaoc-images/unaocdes7.png',
            '/assets/unaoc-images/unaocdes8.png',
            '/assets/unaoc-images/unaocdes9.png',
            '/assets/unaoc-images/unaocdoc.png',
            '/assets/unaoc-images/unaocmenuapp.png',
            '/assets/unaoc-images/unaocweb.png',
            '/assets/unaoc-images/unaocweb5.png',
            '/assets/unaoc-images/unaocweb6.png',
            '/assets/unaoc-images/unaocweb7.png',
            '/assets/unaoc-images/unaocweb8.png'
        ],
